    ...
    <el-container id="beta-component">
        ...
        <transition name="translate">
            <div id="beta-page-about-us" v-if="aboutUs">
                ...
                <h2>About Procezeus</h2>
                <div class="about-us-text">
                    <el-row>
                        <el-col :lg="{span: 12, offset: 0}">
                            <img alt="" src="../assets/cartoon_zeus.png" id="about-us-zeus">
                        </el-col>
                        <el-col :lg="{span: 12, offset: 0}">
                ...
                <h2>About the Cyberjustice Laboratory</h2>
                <div class="about-us-text">
                    <el-row>
                        <el-col :lg="{span: 12, offset: 0}">
                        ...
                        <el-col :lg="{span: 12, offset: 0}">
                            <img alt="" src="../assets/cjl.png" id="about-us-cjl">
                        </el-col>
                    </el-row>
                </div>
            </div>
