...
class Responses:
    ...
    static_claim_responses = {
        ...
        "abandoned_premises": "The landlord must minimize the damages by trying to rent the dwelling to another person. He may claim the tenant who has abandoned the premises a relocation indemnity to recover the lost rent. The landlord has three years to file the application at the Régie du logement.",
        "lease_cancellation_immediately_after_signing": "No. There is no allowable delay after signing a lease.",
        "leave_apartment_no_lease": "A tenant always has a lease, whether it is written or verbal. If there is no fixed term for the lease, the tenant must give to the landlord a notice of one month before leaving the premises.",
        "leave_apartment_no_lease": "A tenant always has a lease, whether it is written or verbal. If there is no fixed term for the lease, the tenant must give to the landlord a notice of one month before leaving the premises.",
        "tenant_urgent_repair_costs_deducted": "He cannot do so without the authorization of the Régie du logement except in the case of a necessary and urgent repair and also in that case the tenant is not able to reach the landlord in order to inform him about the situation.",
        "landlord_neglects_necessary_repairs": "There are many recourses available to the tenant: rent reduction; rent deposit; authorization of the Régie to do himself the repairs; resiliation of the lease; Damages; order to force the landlord to make the repairs. A decision must be rendered by the Régie du logement allowing one of these recourses to be applied.",
        "noisy_tenant": "Whatever the time of day, according to reasonable circumstances, a tenant cannot make excessive noise.",
        "paying_repairs_for_sink_toilet": "The landlord must pay for the repairs except if they can establish that the tenant is responsible for the problem.",
        "landlord_entering_occupied_apartment": "The landlord must give the tenant a 24 hour notice and make the visit between 9:00 AM and 9:00 PM.",
        "apartment_too_cold": "There is no specified date for heating the apartment. The landlord must start to heat the dwellings of the building as soon as the climatic conditions justify it. Although neither law or most municipal by-law are specific in this area, the temperature of the dwelling should be around 21C",
        "unreasonable_rent_increase": "There is no fixed rate increase applied by the Régie du logement. Each case is treated specifically. The Régie takes into account, in calculating the rent variation, the income of the building and the municipal and school taxes, the insurance bills, the energy costs, maintenance and service costs. Also, it sees to apply a return on capital expenditures, if there were such expenditures, and indexes the net income of the building. In order to calculate precisely the rent variation for a dwelling, see the section: https:\/\/www.rdl.gouv.qc.ca\/en\/calculation-for-the-fixing-of-rent"
    }
