...
class GramClassifier(object):
    ...
    def __init__(self, baseName, inputFiles, forceTrain):
        if os.path.exists(os.getcwd() + '/old_data/' + baseName + '/' + baseName + '.pickle') \
                and not forceTrain:
    ...
    def createFromTraining(self, baseName, inputFiles):
        ...
        f = open(os.getcwd() + '/old_data/' + baseName +
                 '/' + baseName + '.pickle', 'wb')
    ...
    def createFromPickle(self, baseName, inputFiles):
        ...
        # Loads old_data from from the given array
        # of input class names. e.g.:
        #
        # Input: ['class']
        #
        # Will load old_data from old_data/class.extended.txt and
    ...
    # Preprocesses the input training old_data
