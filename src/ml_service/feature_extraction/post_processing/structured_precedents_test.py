...
from feature_extraction.post_processing.structured_precedents import StructuredPrecedent
...
class StructuredPrecedentsTest(unittest.TestCase):
    def test_create_structure_from_data_tuple(self):
        ...
        precedents = StructuredPrecedent()
    ...
    def test_create_structure_from_cluster_files_test(self):
        ...
        structured_precedent.create_structure_from_cluster_files(Global.test_data_directory+"clusters/", Global.test_data_directory+"clusters/")
