from feature_extraction.Preprocessing.Arek_Parser.related_word_fetcher import find_related, _find_plural, _find_fem_plural, _find_feminin, _find_conjugation, _find_synonym
