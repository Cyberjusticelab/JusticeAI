...
binary_names_dict = {
    ...
    'regressor_means': ['https://capstone.cyberjustice.ca/data/bin/regressor_means.bin', 871],
    ...
    'similarity_model': ['https://capstone.cyberjustice.ca/data/bin/similarity_model.bin', 31335546],
