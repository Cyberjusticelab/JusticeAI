...
binary_names_dict = {
    ...
    'multi_class_svm_model': ['https://capstone.cyberjustice.ca/data/bin/multi_class_svm_model.bin', 11404929],
    'classifier_labels': ['https://capstone.cyberjustice.ca/data/bin/classifier_labels.bin', 349],
